...
{
    ASSERT_NO_THROW(TDynamicVector<int> a(5));
}

TEST(TDynamicVector, cant_create_too_large_vector)
{
    ASSERT_ANY_THROW(TDynamicVector<int> a(MAX_VECTOR_SIZE + 1));
}

TEST(TDynamicVector, throws_when_create_vector_with_negative_length)
{
    ASSERT_ANY_THROW(TDynamicVector<int> a(-5));
}
...
TEST(TDynamicVector, can_create_copied_vector)
{
    ...
    ASSERT_NO_THROW(TDynamicVector<int> b(a));
}
